...
incumbent president's party on logit retirements; indicators for midterm year (0
for a midterm, 1 for a presidential year), house (1 if incumbent president's
party controls the House), and presidential control (1 for a Dem. president);
GDP change over the past year, log unemployment rate; and logit presidential
approval.
...
d_firms |>
    ...
    arrange(herding) |>
ggplot(aes(bias, stdev, color=herding,label=lab, size=n)) +
