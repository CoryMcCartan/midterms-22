...
To account for irreducible model uncertainty and shift over time, we manually increase uncertainty for several parameters: the bias $\beta_\mu$, and the firm bias uncertainty $\tau_f^2$ (and the prior uncertainty on the actual levels of the firm random effects).
We also regress the prior on $\beta_\mu$ by 20% towards zero.
