...
\end{align*}
$$
where $i$ indexes the polls, $f[i]$ is the firm, $t[i]$ is the year, $u[i]$ is the methodology, $v[i]$ is the survey population, $m_{f[i]}$ is the herding variable for each firm, and $x_i$ is a vector of poll variance predictors: $\log(N_i)$, $\sqrt{\text{time to elec.}}$, and the LV/not indicator.
