...
viewof tab_distr = {
    ...
    let cols = ["name", "cands", "inc_seat", "pr_dem", "interval", "part_base", ];
    let cols_small = ["name", "cands", "pr_dem", "interval", "part_base", ];
    let cols_tiny = ["name", "cands", "pr_dem", "interval", ];
